...
public class building1location extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_building1location);
        ...
        for (int i = 0; i < numberBuildings; i++) {
            ...
            arrayButtons[i].setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent goToFloorPlan = new Intent(building1location.this, floorplan.class);
        ...
        search.setOnClickListener(new View.OnClickListener(){
                                      ...
                                      public void onClick(View v){
                                          Intent theintent = new Intent(building1location.this, buildingsearch.class);
